...
def get_stream():
    ...
    try:
        if source == 'kodik':
            m3u8_url = kodik.get_m3u8_playlist_link(id=kp_id, id_type='kinopoisk', seria_num=episode)
            ...
            stream = animego.aniboom_get_stream_for_voice(translation_id=first_voice['translation_id'], episode=episode, anime_id=kp_id)
